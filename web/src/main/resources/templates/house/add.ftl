								...
								<section id="property-features" class="block">
									<section>
										...
										<ul class="submit-features">
											<li>
												<div class="checkbox"><label><input name="featureList" value="满五年" type="checkbox">满五年</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="满两年" type="checkbox">满两年</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="南北通透" type="checkbox">南北通透</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="采光好" type="checkbox">采光好</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="高楼层" type="checkbox">高楼层</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="环境好" type="checkbox">环境好</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="价格合理" type="checkbox">价格合理</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="楼龄新" type="checkbox">楼龄新</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="带阳台" type="checkbox">带阳台</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="税少" type="checkbox">税少</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="得房率高" type="checkbox">得房率高</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="临地铁" type="checkbox">临地铁</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="学区房" type="checkbox">学区房</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="户型好" type="checkbox">户型好</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="没有遮挡" type="checkbox">没有遮挡</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="次顶层" type="checkbox">次顶层</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="落地窗" type="checkbox">落地窗</label></div>
											</li>
											<li>
												<div class="checkbox"><label><input name="featureList" value="精装修" type="checkbox">精装修</label></div>
											</li>
										</ul>
									</section>
								</section>
