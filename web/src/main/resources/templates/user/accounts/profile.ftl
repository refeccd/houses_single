								...
								<div class="col-md-9 col-sm-9">
									<form role="form" id="form-account-profile" method="post" action="/accounts/profile">
										...
										<section id="about-me">
											<h3>About Me</h3>
											<div class="form-group">
												<label for="form-contact-agent-message"></label>
											...
											<div class="col-md-6 col-sm-6">
												<form role="form" id="form-account-password" method="post" action="/accounts/changePassword">
													...
													<div class="form-group">
														...
														<input type="password" name="passwd" class="form-control" id="form-account-password-current">
													</div><!-- /.form-group -->
													<div class="form-group">
													...
													<div class="form-group">
														...
														<input type="password" name="confirmPasswd" class="form-control" id="form-account-password-confirm-new">
													</div><!-- /.form-group -->
													<div class="form-group clearfix">
